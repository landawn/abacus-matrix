...
public final class LongMatrix extends AbstractMatrix<long[], LongList, LongStream, Stream<LongStream>, LongMatrix> {
     ...
     */
    public LongMatrix(final long[][] a) throws IllegalArgumentException {
     ...
     * }</pre>
     *
     * @return the shared empty {@code LongMatrix} singleton
     */
    ...
    /**
     * Wraps the supplied two-dimensional long array as {@code LongMatrix}.
     *
     ...
     *
     * LongMatrix.wrap((long[][]) null);               // throws IllegalArgumentException
     * LongMatrix.wrap().isEmpty();                    // returns true (no rows)
     * LongMatrix.wrap(new long[][] {{1L, 2L}, {3L}}); // throws IllegalArgumentException (non-rectangular)
     * }</pre>
     *
     ...
     *         different lengths (i.e. the array is not rectangular), or if two positions reference the same row array
     */
    public static LongMatrix wrap(final long[]... a) throws IllegalArgumentException {
     ...
     * @return a new {@code LongMatrix} backed by a deep copy of {@code a} when it is non-empty, or the shared empty matrix if {@code a} has no rows
     * @throws IllegalArgumentException if {@code a} is {@code null}, if any row of {@code a} is {@code null}, or if the rows have
     *         different lengths (i.e. the array is not rectangular)
     * @see #wrap(long[][])
     * @see #copy()
     */
    public static LongMatrix copyOf(final long[]... a) throws IllegalArgumentException {
        N.checkArgNotNull(a, "Matrix array cannot be null");
     ...
     */
    public static LongMatrix from(final int[]... a) throws IllegalArgumentException {
        N.checkArgNotNull(a, "Matrix array cannot be null");
    ...
    /**
     * Creates a new {@code 1 x columnCount} matrix filled with pseudo-random {@code long} values
     ...
     * LongMatrix.randomRow(-1);                // throws IllegalArgumentException (negative columnCount)
     * }</pre>
     *
     * @param columnCount the number of columns in the new matrix; must be {@code >= 0}
     * @return a new {@code LongMatrix} of dimensions {@code 1 x columnCount} filled with random values
     * @throws IllegalArgumentException if {@code columnCount} is negative
     * @see #random(int, int)
     */
    public static LongMatrix randomRow(final int columnCount) throws IllegalArgumentException {
     ...
     */
    public static LongMatrix random(final int rowCount, final int columnCount) throws IllegalArgumentException {
     ...
     */
    public static LongMatrix range(final long startInclusive, final long endExclusive) throws IllegalArgumentException {
     ...
     */
    public static LongMatrix range(final long startInclusive, final long endExclusive, final long step) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if the resulting range would contain more than {@code Integer.MAX_VALUE} elements
     */
    public static LongMatrix rangeClosed(final long startInclusive, final long endInclusive) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if {@code step} is zero, or if the resulting range would contain more than {@code Integer.MAX_VALUE} elements
     */
    public static LongMatrix rangeClosed(final long startInclusive, final long endInclusive, final long step) throws IllegalArgumentException {
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.ofMainDiagonal(new long[] {1L, 2L, 3L});
     * matrix.get(0, 0);                       // returns 1L
     * matrix.get(1, 1);                       // returns 2L
     * matrix.get(0, 1);                       // returns 0L (off-diagonal)
     * // matrix is [[1, 0, 0], [0, 2, 0], [0, 0, 3]]
     *
     * LongMatrix.ofMainDiagonal(null);                    // throws IllegalArgumentException (null array)
     * LongMatrix.ofMainDiagonal(new long[0]).isEmpty();   // returns true
     * }</pre>
     *
     ...
     * @see #ofAntiDiagonal(long[])
     * @see #ofDiagonals(long[], long[])
     */
    public static LongMatrix ofMainDiagonal(final long[] mainDiagonal) throws IllegalArgumentException {
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.ofAntiDiagonal(new long[] {1L, 2L, 3L});
     * matrix.get(0, 2);                       // returns 1L
     * matrix.get(2, 0);                       // returns 3L
     * matrix.get(0, 0);                       // returns 0L (off anti-diagonal)
     * // matrix is [[0, 0, 1], [0, 2, 0], [3, 0, 0]]
     *
     * LongMatrix.ofAntiDiagonal(null);                    // throws IllegalArgumentException (null array)
     * LongMatrix.ofAntiDiagonal(new long[0]).isEmpty();   // returns true
     * }</pre>
     *
     ...
     * @see #ofMainDiagonal(long[])
     * @see #ofDiagonals(long[], long[])
     */
    public static LongMatrix ofAntiDiagonal(final long[] antiDiagonal) throws IllegalArgumentException {
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.ofDiagonals(new long[] {1L, 2L, 3L}, new long[] {4L, 5L, 6L});
     ...
     *
     * LongMatrix.ofDiagonals(null, null);                                   // throws IllegalArgumentException (both null)
     * LongMatrix.ofDiagonals(new long[] {1L, 2L}, new long[] {3L, 4L, 5L}); // throws IllegalArgumentException (length mismatch)
     * }</pre>
     *
     ...
     * @see #ofAntiDiagonal(long[])
     */
    public static LongMatrix ofDiagonals(final long[] mainDiagonal, final long[] antiDiagonal) throws IllegalArgumentException {
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * Matrix<Long> boxed = Matrix.wrap(new Long[][] {{1L, 2L}, {3L, 4L}});
     * LongMatrix primitive = LongMatrix.unbox(boxed);
     * primitive.get(0, 1);                    // returns 2L
     * primitive.get(1, 0);                    // returns 3L
     *
     * Matrix<Long> withNull = Matrix.wrap(new Long[][] {{1L, null}});
     ...
     * @return a new {@code LongMatrix} with primitive long values, with the same shape as {@code x}
     * @throws IllegalArgumentException if {@code x} is {@code null}
     * @see #boxed()
     */
    public static LongMatrix unbox(final Matrix<Long> x) throws IllegalArgumentException {
    ...
    public <E extends Exception> void updateRow(final int rowIndex, final Throwables.LongUnaryOperator<E> operator)
        ...
        final long[] row = a[rowIndex];

        for (int i = 0; i < columnCount; i++) {
            row[i] = operator.applyAsLong(row[i]);
        }
    }
     ...
     *
     * LongMatrix small = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     ...
     *
     * matrix.setMainDiagonal(new long[] {1L}); // throws IllegalArgumentException (length != min(rowCount, columnCount))
     * LongMatrix rectangular = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}, {4L, 5L, 6L}});
     ...
     *
     * matrix.setAntiDiagonal(new long[] {1L}); // throws IllegalArgumentException (length != min(rowCount, columnCount))
     * LongMatrix rectangular = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}, {4L, 5L, 6L}});
     ...
     *
     * <p>The operation may be performed in parallel for large matrices to improve performance. If parallelized, the supplied function must be thread-safe.
     * Unlike {@link #updateAll(Throwables.LongUnaryOperator)}, this method leaves the source matrix unchanged.</p>
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{123L, 256L}, {300L, 401L}});
     * IntMatrix intMatrix = matrix.mapToInt(x -> (int) (x % 100));
     * intMatrix.get(0, 0);                    // returns 23
     * intMatrix.get(1, 0);                    // returns 0 ((int)(300 % 100))
     *
     * LongMatrix big = LongMatrix.wrap(new long[][] {{Long.MAX_VALUE}});
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{4L, 9L}, {16L, 25L}});
     ...
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{0L, 0L, 0L}, {0L, 0L, 0L}});
     * matrix.copyFrom(new long[][] {{1L, 2L}, {3L, 4L}});
     * matrix.get(0, 0);                       // returns 1L
     * matrix.get(0, 2);                       // returns 0L (source row is narrower, so this column is not overwritten)
     * // matrix is [[1, 2, 0], [3, 4, 0]]
     *
     * LongMatrix big = LongMatrix.wrap(new long[][] {{0L, 0L}, {0L, 0L}});
     * big.copyFrom(new long[][] {{1L, 2L, 3L}, {4L, 5L, 6L}, {7L, 8L, 9L}});
     * big.get(1, 1);                          // returns 5L (only overlapping region copied)
     *
     * matrix.copyFrom((long[][]) null);          // throws IllegalArgumentException (source is null)
     * }</pre>
     *
     * @param source the two-dimensional array to copy values from; must not be {@code null}
     * @throws IllegalArgumentException if {@code source} is {@code null}
     * @see #copyFrom(int, int, long[][])
     */
    public void copyFrom(final long[][] source) throws IllegalArgumentException {
        copyFrom(0, 0, source);
    }
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{0L, 0L, 0L}, {0L, 0L, 0L}, {0L, 0L, 0L}});
     * matrix.copyFrom(1, 1, new long[][] {{1L, 2L}, {3L, 4L}});
     * matrix.get(1, 1);                       // returns 1L
     * matrix.get(2, 2);                       // returns 4L
     * matrix.get(0, 0);                       // returns 0L (outside the copied region)
     * // matrix is [[0, 0, 0], [0, 1, 2], [0, 3, 4]]
     *
     * matrix.copyFrom(0, 0, (long[][]) null);                // throws IllegalArgumentException (source is null)
     * matrix.copyFrom(-1, 0, new long[][] {{1L}});           // throws IndexOutOfBoundsException (destRowIndex < 0)
     * matrix.copyFrom(0, 5, new long[][] {{1L}});            // throws IndexOutOfBoundsException (destColumnIndex > columnCount)
     * }</pre>
     *
     ...
     * @throws IllegalArgumentException if {@code source} is {@code null}
     */
    public void copyFrom(final int destRowIndex, final int destColumnIndex, final long[][] source) throws IndexOutOfBoundsException, IllegalArgumentException {
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix original = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     ...
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}, {5L, 6L}});
     * LongMatrix subset = matrix.copyRows(1, 3);
     ...
     */
    @Override
    public LongMatrix copyRows(final int fromRowIndex, final int toRowIndex) throws IndexOutOfBoundsException {
     ...
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}, {4L, 5L, 6L}, {7L, 8L, 9L}});
     * LongMatrix submatrix = matrix.copyRegion(0, 2, 1, 3);
     * submatrix.get(0, 0);                    // returns 2L
     * submatrix.get(1, 1);                    // returns 6L -> {{2, 3}, {5, 6}}
     *
     * matrix.copyRegion(0, 1, 0, 1).get(0, 0);     // returns 1L (single-cell submatrix)
     *
     ...
     */
    @Override
    public LongMatrix copyRegion(final int fromRowIndex, final int toRowIndex, final int fromColumnIndex, final int toColumnIndex)
     ...
     */
    @Override
    public LongMatrix resize(final int newRowCount, final int newColumnCount) throws IllegalArgumentException {
     ...
     * {@code 0 x 0} result uses the shared empty matrix.</p>
     *
     * <p><b>Comparison with {@link #pad(int, int, int, int, long)}:</b>
     * {@code resize} takes <em>absolute</em> target dimensions and may truncate existing content.
     * {@code pad} takes <em>relative</em> padding amounts per edge and <em>never truncates</em>.
     * Use {@code pad} when the entire original content must be preserved.</p>
     *
     ...
     * LongMatrix bordered = matrix.pad(1, 1, 1, 1);
     ...
     * LongMatrix shifted = matrix.pad(0, 0, 2, 0);
     ...
     */
    @Override
    public LongMatrix pad(final int padTop, final int padBottom, final int padLeft, final int padRight) throws IllegalArgumentException {
     ...
     * LongMatrix bordered = matrix.pad(1, 1, 1, 1, 9L);
     * bordered.get(0, 0);                     // returns 9L (border cell)
     * bordered.get(1, 1);                     // returns 1L (original top-left)
     * bordered.get(2, 2);                     // returns 4L (original bottom-right)
     *
     * // Asymmetric: 2 columns on the left only, no row padding
     * LongMatrix shifted = matrix.pad(0, 0, 2, 0, 7L);
     * shifted.get(0, 0);                      // returns 7L (left padding)
     * shifted.get(0, 2);                      // returns 1L (original shifted right)
     *
     * matrix.pad(-1, 0, 0, 0, 9L);        // throws IllegalArgumentException (negative padding)
     * }</pre>
     *
     * @param padTop number of padding rows to add above the original matrix; must be {@code >= 0}
     * @param padBottom number of padding rows to add below the original matrix; must be {@code >= 0}
     ...
     * @see #resize(int, int, long)
     */
    public LongMatrix pad(final int padTop, final int padBottom, final int padLeft, final int padRight, final long defaultValue)
     ...
     *
     * LongMatrix single = LongMatrix.wrap(new long[][] {{1L}});
     ...
     *
     * LongMatrix single = LongMatrix.wrap(new long[][] {{1L, 2L}});
     ...
     *
     * LongMatrix single = LongMatrix.wrap(new long[][] {{5L}});
     ...
     *
     * LongMatrix wide = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}});  // 1x3
     ...
     *
     * LongMatrix rect = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     ...
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}, {4L, 5L, 6L}});
     * LongMatrix reshaped = matrix.reshapeAndPad(3, 2);
     * reshaped.rowCopy(0);                    // returns [1, 2] -> [[1, 2], [3, 4], [5, 6]]
     * reshaped.get(2, 1);                     // returns 6L
     *
     * LongMatrix extended = matrix.reshapeAndPad(2, 4);
     ...
     */
    @Override
    public LongMatrix reshapeAndPad(final int newRowCount, final int newColumnCount) throws IllegalArgumentException {
        N.checkArgument(newRowCount >= 0, MSG_NEGATIVE_DIMENSION, cs.newRowCount, newRowCount);
        N.checkArgument(newColumnCount >= 0, MSG_NEGATIVE_DIMENSION, cs.newColumnCount, newColumnCount);
        checkNonNegativeShape(newRowCount, newColumnCount);
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{1L, 2L}});
     ...
     * @return a new {@code LongMatrix} with dimensions {@code (rowCount * rowRepeats) × (columnCount * columnRepeats)}
     ...
     * LongMatrix.wrap(new long[][] {{7L}}).flatten().get(0); // returns 7L (single element)
     * }</pre>
     *
     ...
     */
    @Override
    public LongList flatten() throws IllegalStateException {
        // Check for overflow before allocation
     ...
     * {@link Arrays#mutateViaFlatArray(long[][], Throwables.Consumer)} for the exact semantics of the
     * underlying operation.</p>
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{5L, 3L}, {4L, 1L}});
     ...
     *
     * LongMatrix.empty().mutateViaFlatArray(arr -> { });  // no-op on empty matrix
     * }</pre>
     *
     ...
     */
    @Override
    public <E extends Exception> void mutateViaFlatArray(final Throwables.Consumer<? super long[], E> action)
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix a = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}, {4L, 5L, 6L}});      // 2x3
     * LongMatrix b = LongMatrix.wrap(new long[][] {{7L, 8L, 9L}, {10L, 11L, 12L}});   // 2x3
     * LongMatrix c = a.stackVertically(b);
     * c.rowCount();                           // returns 4
     * c.rowCopy(2);                           // returns [7, 8, 9]
     * c.get(3, 2);                            // returns 12L
     *
     * LongMatrix mismatch = LongMatrix.wrap(new long[][] {{1L, 2L}});
     ...
     *
     * LongMatrix mismatch = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}});
     ...
     * wraps around modulo 2<sup>64</sup> on overflow.
     * To be told about an overflow rather than silently wrapping, use {@link #addExact(LongMatrix)}.</p>
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     ...
     *
     * LongMatrix big = LongMatrix.wrap(new long[][] {{Long.MAX_VALUE}});
     * big.add(LongMatrix.wrap(new long[][] {{1L}})).get(0, 0); // returns -9223372036854775808L (long overflow wraps)
     *
     * LongMatrix wrongShape = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}});
    ...
    public LongMatrix add(final LongMatrix other) throws IllegalArgumentException {
        ...
        if (Matrices.shouldRunInParallel(this)) {
            ...
            for (int i = 0; i < rowCount; i++) {
                final long[] row = a[i];
                final long[] otherRow = otherArray[i];
                final long[] resultRow = result[i];
     ...
     * {@link #subtractExact(LongMatrix)}.</p>
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix a = LongMatrix.wrap(new long[][] {{5L, 6L}, {7L, 8L}});
     * LongMatrix b = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     * LongMatrix diff = a.subtract(b);
     * diff.get(0, 0);                         // returns 4L
     * diff.get(1, 1);                         // returns 4L -> [[4, 4], [4, 4]]
     *
     * LongMatrix min = LongMatrix.wrap(new long[][] {{Long.MIN_VALUE}});
     * min.subtract(LongMatrix.wrap(new long[][] {{1L}})).get(0, 0); // returns 9223372036854775807L (long overflow wraps)
     *
     * LongMatrix wrongShape = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}});
     ...
     * 2<sup>64</sup>.
     * To be told about an overflow rather than silently wrapping, use
     * {@link #matrixMultiplyExact(LongMatrix)}.</p>
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix a = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     ...
     *
     * LongMatrix m2x3 = LongMatrix.wrap(new long[][] {{1L, 2L, 3L}, {4L, 5L, 6L}});      // 2x3
     * LongMatrix m3x2 = LongMatrix.wrap(new long[][] {{7L, 8L}, {9L, 10L}, {11L, 12L}}); // 3x2
     ...
     * @see #matrixMultiplyExact(LongMatrix)
     */
        ...
        if (Matrices.shouldRunMatrixMultiplyInParallel(this, newColumnCount)) {
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                for (int k = 0; k < columnCount; k++) {
                    final long aik = row[k];
                    final long[] otherRow = otherArray[k];
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix primitive = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     ...
     *
     * LongMatrix max = LongMatrix.wrap(new long[][] {{Long.MAX_VALUE}});
     ...
     *
     * LongMatrix big = LongMatrix.wrap(new long[][] {{16_777_217L}});
     ...
     * LongMatrix a = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     * LongMatrix b = LongMatrix.wrap(new long[][] {{5L, 6L}, {7L, 8L}});
     * LongMatrix c = LongMatrix.wrap(new long[][] {{9L, 10L}, {11L, 12L}});
     *
     ...
     * }</pre>
     *
     * @return a LongStream of {@code min(rowCount, columnCount)} main-diagonal elements,
     ...
     * }</pre>
     *
     * @return a LongStream of {@code min(rowCount, columnCount)} anti-diagonal elements,
     *         empty when either dimension is zero
     */
    @Override
     ...
     * LongMatrix.wrap(new long[][] {{7L}}).rowMajorStream().sum(); // returns 7L (single element)
     * }</pre>
     *
     ...
     * LongMatrix.wrap(new long[][] {{7L}}).columnMajorStream().sum(); // returns 7L (single element)
     * }</pre>
     *
     ...
     * LongMatrix.wrap(new long[][] {{7L, 8L}}).rowStreams().count(); // returns 1 (single row)
     * }</pre>
     *
     ...
     * LongMatrix.wrap(new long[][] {{7L}, {8L}}).columnStreams().count(); // returns 1 (single column)
     * }</pre>
     *
     ...
     * @param fromColumnIndex the starting column index (inclusive, 0-based)
     * @param toColumnIndex the ending column index (exclusive)
     * @return a Stream of LongStream objects, one per selected column; empty only when the range
     ...
     * or accumulating). Use {@link #map(Throwables.LongUnaryOperator)} to create a transformed matrix,
     * or {@link #updateAll(Throwables.LongUnaryOperator)} to modify this matrix in place.</p>
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LongMatrix matrix1 = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     * LongMatrix matrix2 = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     * boolean sameHash = matrix1.hashCode() == matrix2.hashCode(); // true (equal content)
     *
     * LongMatrix different = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 5L}});
     ...
     * LongMatrix m2 = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 4L}});
     * m1.equals(m2);                          // returns true (same shape and elements)
     *
     * LongMatrix m3 = LongMatrix.wrap(new long[][] {{1L, 2L}, {3L, 5L}});
     ...
     *
     * LongMatrix single = LongMatrix.wrap(new long[][] {{7L}});
