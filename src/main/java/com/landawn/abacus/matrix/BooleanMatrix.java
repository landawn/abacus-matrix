...
public final class BooleanMatrix extends AbstractMatrix<boolean[], BooleanList, Stream<Boolean>, Stream<Stream<Boolean>>, BooleanMatrix> {
    ...
    /** The shared {@code 0 x 0} boolean matrix returned by {@link #empty()} and public empty-array factories. */
     ...
     * }</pre>
     *
     * @param a the two-dimensional boolean array whose rows are shared, must not be {@code null}
     ...
     */
    public BooleanMatrix(final boolean[][] a) throws IllegalArgumentException {
    ...
    /**
     * Wraps the supplied two-dimensional boolean array as {@code BooleanMatrix}.
     *
     ...
     * matrix.rowCount();                              // returns 2
     *
     * BooleanMatrix.wrap((boolean[][]) null);                      // throws IllegalArgumentException
     * BooleanMatrix.wrap().isEmpty();                              // returns true (no rows -> empty singleton)
     ...
     *         different lengths (i.e. the array is not rectangular), or if two positions reference the same row array
     */
    public static BooleanMatrix wrap(final boolean[]... a) throws IllegalArgumentException {
     ...
     * @see #copy()
     */
    public static BooleanMatrix copyOf(final boolean[]... a) throws IllegalArgumentException {
        N.checkArgNotNull(a, "Matrix array cannot be null");
     ...
     * BooleanMatrix.randomRow(-1);                // throws IllegalArgumentException (negative columnCount)
     * }</pre>
     *
     ...
     * @see #random(int, int)
     */
    public static BooleanMatrix randomRow(final int columnCount) throws IllegalArgumentException {
     ...
     * BooleanMatrix.random(0, 3).columnCount();    // returns 3 (shape is preserved)
     ...
     */
    public static BooleanMatrix random(final int rowCount, final int columnCount) throws IllegalArgumentException {
        return random(rowCount, columnCount, defaultRandomGenerator());
    }

    /**
     * Creates a matrix of random boolean values using the caller-supplied random source.
     *
    ...
    public static BooleanMatrix random(final int rowCount, final int columnCount, final RandomGenerator randomGenerator) throws IllegalArgumentException {
        ...
        for (boolean[] ea : a) {
            for (int i = 0; i < columnCount; i++) {
                ea[i] = randomGenerator.nextBoolean();
            }
        }
     ...
     *
     * BooleanMatrix.ofMainDiagonal((boolean[]) null);             // throws IllegalArgumentException (null array)
     * BooleanMatrix.ofMainDiagonal(new boolean[0]).isEmpty();     // returns true
     * }</pre>
     *
     ...
     * @see #ofAntiDiagonal(boolean[])
     * @see #ofDiagonals(boolean[], boolean[])
     */
    public static BooleanMatrix ofMainDiagonal(final boolean[] mainDiagonal) throws IllegalArgumentException {
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * BooleanMatrix matrix = BooleanMatrix.ofAntiDiagonal(new boolean[] {true, false, true});
     * // Resulting 3x3 matrix:
     * //   {false, false, true},
     * //   {false, false, false},
     * //   {true,  false, false}
     ...
     *
     * BooleanMatrix.ofAntiDiagonal((boolean[]) null);             // throws IllegalArgumentException (null array)
     * BooleanMatrix.ofAntiDiagonal(new boolean[0]).isEmpty();     // returns true
     * }</pre>
     *
     ...
     * @see #ofMainDiagonal(boolean[])
     * @see #ofDiagonals(boolean[], boolean[])
     */
    public static BooleanMatrix ofAntiDiagonal(final boolean[] antiDiagonal) throws IllegalArgumentException {
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * BooleanMatrix matrix = BooleanMatrix.ofDiagonals(new boolean[] {true, true, true}, new boolean[] {true, false, true});
     ...
     *
     * BooleanMatrix.ofDiagonals(null, null);                                        // throws IllegalArgumentException (both null)
     * BooleanMatrix.ofDiagonals(new boolean[] {true}, new boolean[] {true, false}); // throws IllegalArgumentException (length mismatch)
     * }</pre>
     *
     ...
     * @see #ofAntiDiagonal(boolean[])
     */
    public static BooleanMatrix ofDiagonals(final boolean[] mainDiagonal, final boolean[] antiDiagonal) throws IllegalArgumentException {
     ...
     *
     * BooleanMatrix.unbox(Matrix.wrap(new Boolean[0][0])).isEmpty();   // returns true
     ...
     * @see #boxed()
     */
    public static BooleanMatrix unbox(final Matrix<Boolean> x) throws IllegalArgumentException {
    ...
    public <E extends Exception> void updateColumn(final int columnIndex, final Throwables.BooleanUnaryOperator<E> operator)
        ...
        for (final boolean[] row : a) {
            row[columnIndex] = operator.applyAsBoolean(row[columnIndex]);
        }
    }
     ...
     * matrix.get(0, 0);                                 // returns true
     *
     * BooleanMatrix wide = BooleanMatrix.wrap(new boolean[][] {{true, false, true}});
     * wide.mainDiagonalCopy();   // returns [true]
     * }</pre>
     *
     * @return a new boolean array containing a copy of the main diagonal elements
     */
    @Override
    public boolean[] mainDiagonalCopy() {
        final int diagonalLength = diagonalLength();
        final boolean[] res = new boolean[diagonalLength];
     ...
     *
     * matrix.setMainDiagonal(new boolean[] {true, true});   // throws IllegalArgumentException (wrong length)
     * BooleanMatrix wide = BooleanMatrix.wrap(new boolean[][] {{true, false, true}});
     * wide.setMainDiagonal(new boolean[] {true});           // supported for a 1x3 matrix
     * }</pre>
     *
     ...
     * BooleanMatrix wide = BooleanMatrix.wrap(new boolean[][] {{true, false, true}});
     * wide.updateMainDiagonal(val -> !val);     // updates its single main-diagonal cell
     * }</pre>
     *
     * @param <E> the type of exception that the operator may throw
     ...
     * {@code (1,columnCount-2)}, and so on.
     * The returned array is a copy; modifications to it will not affect the matrix.</p>
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     ...
     *
     * BooleanMatrix wide = BooleanMatrix.wrap(new boolean[][] {{true, false, true}});
     * wide.antiDiagonalCopy();   // returns [true] (the top-right cell)
     * }</pre>
     *
     * @return a new boolean array containing a copy of the anti-diagonal elements
     */
    @Override
    public boolean[] antiDiagonalCopy() {
        final int diagonalLength = diagonalLength();
        final boolean[] res = new boolean[diagonalLength];
     ...
     * matrix.get(2, 0);          // returns true
     *
     * matrix.setAntiDiagonal(new boolean[] {true, true});   // throws IllegalArgumentException (wrong length)
     * BooleanMatrix wide = BooleanMatrix.wrap(new boolean[][] {{true, false, true}});
     * wide.setAntiDiagonal(new boolean[] {true});           // supported for a 1x3 matrix
     * }</pre>
     *
     ...
     * BooleanMatrix wide = BooleanMatrix.wrap(new boolean[][] {{true, false, true}});
     * wide.updateAntiDiagonal(val -> !val);     // updates its single anti-diagonal cell
     * }</pre>
     *
     * @param <E> the type of exception that the operator may throw
     ...
     *
     * BooleanMatrix matrix2 = BooleanMatrix.wrap(new boolean[][] {{true, false}, {true, false}});
     ...
     */
    public void copyFrom(final boolean[][] source) throws IllegalArgumentException {
        copyFrom(0, 0, source);
    }
     ...
     *     {true,  true}
     * });
     * BooleanMatrix subset = matrix.copyRows(1, 3);   // rows 1 and 2
     ...
     *
     * matrix.copyRows(0, 0).rowCount();   // returns 0 (empty range)
     ...
     */
    @Override
    public BooleanMatrix copyRows(final int fromRowIndex, final int toRowIndex) throws IndexOutOfBoundsException {
     ...
     * });
     * BooleanMatrix subMatrix = matrix.copyRegion(0, 2, 1, 3);   // rows 0-1, columns 1-2
     * subMatrix.get(0, 0);                                 // returns false (original (0,1))
     * subMatrix.get(1, 1);                                 // returns false (original (1,2))
     *
     * BooleanMatrix col = matrix.copyRegion(0, 3, 2, 3);   // all rows, column 2 only
     * col.columnCount();                             // returns 1
     * col.get(0, 0);                                 // returns true
     *
     * matrix.copyRegion(0, 2, 1, 9);   // throws IndexOutOfBoundsException (toColumnIndex > columnCount)
     * matrix.copyRegion(0, 2, 3, 1);   // throws IndexOutOfBoundsException (fromColumnIndex > toColumnIndex)
     * }</pre>
     *
     * @param fromRowIndex the starting row index (inclusive, 0-based)
     * @param toRowIndex the ending row index (exclusive)
     ...
     */
    @Override
    public BooleanMatrix copyRegion(final int fromRowIndex, final int toRowIndex, final int fromColumnIndex, final int toColumnIndex)
     ...
     */
    @Override
    public BooleanMatrix resize(final int newRowCount, final int newColumnCount) throws IllegalArgumentException {
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * BooleanMatrix matrix = BooleanMatrix.wrap(new boolean[][] {{true, true}, {true, true}});
     *
     * // Uniform 1-cell border of false
     * BooleanMatrix bordered = matrix.pad(1, 1, 1, 1);
     ...
     */
    @Override
    public BooleanMatrix pad(final int padTop, final int padBottom, final int padLeft, final int padRight) throws IllegalArgumentException {
        return pad(padTop, padBottom, padLeft, padRight, false);
    }
     ...
     * BooleanMatrix shifted = matrix.pad(0, 0, 2, 0, true);
     * shifted.columnCount();     // returns 4
     * shifted.get(0, 0);         // returns true  (padding filled with true)
     * shifted.get(0, 2);         // returns true  (original content)
     *
     * matrix.pad(0, 0, 0, 0, true).equals(matrix);   // returns true (no padding)
     * matrix.pad(0, -1, 0, 0, true);                 // throws IllegalArgumentException (negative padding)
     * }</pre>
     *
     * @param padTop number of padding rows to add above the original matrix; must be {@code >= 0}
     * @param padBottom number of padding rows to add below the original matrix; must be {@code >= 0}
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * BooleanMatrix matrix = BooleanMatrix.wrap(new boolean[][] {{true, false, false}, {true, true, false}});
     ...
     * BooleanMatrix.wrap(new boolean[3][0]).rotate90().isEmpty();   // returns true (zero columns)
     * }</pre>
     *
     ...
     * BooleanMatrix.wrap(new boolean[3][0]).rotate180().columnCount();   // returns 0
     * }</pre>
     *
     ...
     * BooleanMatrix.wrap(new boolean[3][0]).rotate270().isEmpty();   // returns true (zero columns)
     * }</pre>
     *
     ...
     * BooleanMatrix reshaped = matrix.reshapeAndPad(2, 2);   // row-major fill
     * reshaped.rowCount();                             // returns 2
     * reshaped.get(0, 0);                              // returns true
     * reshaped.get(1, 0);                              // returns true
     *
     * BooleanMatrix bigger = matrix.reshapeAndPad(2, 3);   // 6 cells > 4 elements -> trailing false
     * bigger.get(1, 2);                              // returns false (unfilled trailing cell)
     * matrix.reshapeAndPad(1, 3);                          // throws IllegalArgumentException (3 cells cannot hold 4 elements)
     * matrix.reshapeAndPad(-1, 4);                         // throws IllegalArgumentException (negative dimension)
     * }</pre>
     *
    ...
    @Override
    public BooleanMatrix reshapeAndPad(final int newRowCount, final int newColumnCount) throws IllegalArgumentException {
        N.checkArgument(newRowCount >= 0, MSG_NEGATIVE_DIMENSION, cs.newRowCount, newRowCount);
        N.checkArgument(newColumnCount >= 0, MSG_NEGATIVE_DIMENSION, cs.newColumnCount, newColumnCount);
        checkNonNegativeShape(newRowCount, newColumnCount);
     ...
     */
    @Override
    public BooleanList flatten() throws IllegalStateException {
        // Check for overflow before allocation
     ...
     */
    @Override
    public <E extends Exception> void mutateViaFlatArray(final Throwables.Consumer<? super boolean[], E> action)
     ...
     * a.and(BooleanMatrix.wrap(new boolean[][] {{true}}));           // throws IllegalArgumentException (shape mismatch)
     * }</pre>
     *
     ...
     * a.or(BooleanMatrix.wrap(new boolean[][] {{true}}));           // throws IllegalArgumentException (shape mismatch)
     * }</pre>
     *
     ...
     * a.xor(BooleanMatrix.wrap(new boolean[][] {{true}}));           // throws IllegalArgumentException (shape mismatch)
     * }</pre>
     *
     ...
     * matrix.countTrue();        // returns 3
     *
     * BooleanMatrix.wrap(new boolean[][] {{true, true}, {true, true}}).countTrue();   // returns 4
     * BooleanMatrix.wrap(new boolean[][] {{false, false}}).countTrue();               // returns 0
     ...
     *
     * BooleanMatrix.wrap(new boolean[][] {{false, false}}).allTrue();   // returns false
     ...
     *
     * BooleanMatrix.wrap(new boolean[][] {{true, true}}).anyTrue();   // returns true
     ...
     *
     * BooleanMatrix m1 = BooleanMatrix.wrap(new boolean[][] {{true, true}});
     * BooleanMatrix m2 = BooleanMatrix.wrap(new boolean[][] {{false, false}});
     ...
     * top.stackVertically(BooleanMatrix.wrap(new boolean[][] {{true}}));   // throws IllegalArgumentException (column mismatch)
     * }</pre>
     *
     ...
     *
     * BooleanMatrix col1 = BooleanMatrix.wrap(new boolean[][] {{true}, {true}, {false}});
     * BooleanMatrix col2 = BooleanMatrix.wrap(new boolean[][] {{false}, {true}, {true}});
     ...
     * left.stackHorizontally(BooleanMatrix.wrap(new boolean[][] {{true}}));    // throws IllegalArgumentException (row mismatch)
     * }</pre>
     *
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * BooleanMatrix primitive = BooleanMatrix.wrap(new boolean[][] {{true, false}, {false, true}});
    ...
    public Matrix<Boolean> boxed() {
        ...
        return new Matrix<>(c, Boolean.class, columnCount);
    }
     ...
     *
     * a.zipWith(BooleanMatrix.wrap(new boolean[][] {{true}}), (x, y) -> x ^ y);  // throws IllegalArgumentException (shape mismatch)
     ...
     * BooleanMatrix a = BooleanMatrix.wrap(new boolean[][] {{true, false}, {true, true}});
     * BooleanMatrix b = BooleanMatrix.wrap(new boolean[][] {{true, true}, {false, true}});
     * BooleanMatrix c = BooleanMatrix.wrap(new boolean[][] {{false, true}, {true, false}});
     *
     ...
     *
     * a.zipWith(b, BooleanMatrix.wrap(new boolean[][] {{true}}), (x, y, z) -> x); // throws IllegalArgumentException (shape mismatch)
     * }</pre>
     *
     * @param <E> the type of exception that the function may throw
     * @param other the second matrix (must have the same dimensions as this matrix)
     ...
     * proceeding for {@code min(rowCount, columnCount)} positions.
     ...
     * Rectangular matrices are supported; the stream length is {@code min(rowCount, columnCount)}.
     *
     * <p>This method streams the anti-diagonal elements starting at
     * {@code (0,columnCount-1)} and moving one row down and one column left.
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * BooleanMatrix matrix1 = BooleanMatrix.wrap(new boolean[][] {{true, false}, {false, true}});
     * BooleanMatrix matrix2 = BooleanMatrix.wrap(new boolean[][] {{true, false}, {false, true}});
     * boolean sameHash = matrix1.hashCode() == matrix2.hashCode(); // true (same content)
     *
     * BooleanMatrix matrix3 = BooleanMatrix.wrap(new boolean[][] {{false, false}, {false, false}});
     ...
     *
     * BooleanMatrix m3 = BooleanMatrix.wrap(new boolean[][] {{true, true}, {false, true}});
     * m1.equals(m3);                                                // returns false (different content)
     * m1.equals(BooleanMatrix.wrap(new boolean[][] {{true, false}})); // returns false (different shape)
     ...
     * BooleanMatrix.wrap(new boolean[][] {{true}}).toString();   // returns "[[true]]"
     *
